...
public class TopicControllerTestCase {
	...
	private PollDao pollRepository = context.mock(PollDao.class);
	private AttachmentService attachmentService = context.mock(AttachmentService.class);
	private HttpServletRequest request = context.mock(HttpServletRequest.class);
    private ForumLimitedTimeDao forumLimitedTimeRepository = context.mock(ForumLimitedTimeDao.class);
